    ...
    return FormGroup(
        [
            ...
            Form(
                ...
                questions=[
                    TextInput(
                        title="What's the end user's name?", name="end_user.name"
                    ),
                    conditional(
                        individual,
                        TextInput(
                            title="What's the end user's email address?",
                            name="contact_email",
                        ),
                    ),
                    conditional(
                        individual,
                        TextInput(
                            title="What's the end user's telephone number?",
                    ...
                    conditional(
                        commercial,
                        TextInput(
                            title="What's the nature of the end user's business?",
                    ...
                    conditional(
                        not individual,
                        TextInput(
                            title="What's the primary contact's name?",
                            name="contact_name",
                        ),
                    ),
                    conditional(
                        not individual,
                        TextInput(
                            title="What's the primary contact's job title?",
                    ...
                    conditional(
                        not individual,
                        TextInput(
                            title="What's the primary contact's email address?",
                            name="contact_email",
                        ),
                    ),
                    conditional(
                        not individual,
                        TextInput(
                            title="What's the primary contact's telephone number?",
                            name="contact_telephone",
                        ),
                    ),
                    TextInput(
                        title="Enter the end user's web address?",
                    ...
                    country_question(
                        countries=get_countries(None, True), prefix="end_user."
                    ),
...
def end_user_advisory_success_page(request, query_reference):
    return success_page(
        ...
        what_happens_next=[
            "You'll receive an email from DIT when your check is finished."
        ],
        links={
            "View your list of end user advisories": reverse_lazy(
                "end_users:end_users"
            ),
    ...
    return Form(
        ...
        back_link=BackLink(
            ...
            reverse_lazy(
                ...
                kwargs={"pk": query_id, "type": "ecju-queries"},
            ),
        ),
