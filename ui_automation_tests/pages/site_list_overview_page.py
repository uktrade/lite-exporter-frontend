class SitesListOverview():
    ...
    def click_on_the_edit_button_at_last_position(self):
        self.driver.find_elements_by_css_selector(self.edit_buttons)[len(self.edit_buttons)-1].click()

    def get_text_of_last_site_name(self):
        return self.driver.find_elements_by_css_selector(self.table_cells)[len(self.table_cells)-3].text
