...
@when(parsers.parse('I click on the "{section}" section'))
def go_to_task_list_section(driver, section):
    TaskListPage(driver).click_on_task_list_section(section)


@then(parsers.parse('The "{section}" section is set to status "{status}"'))
def go_to_task_list_section(driver, section, status):
