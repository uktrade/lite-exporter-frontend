...
def filter_by_part_no(driver, context, part_number):
    ...
    application_goods_list.type_into_filter_part_number_search_box_and_filter(
        part_number
    )
...
def filter_by_description(driver, context, description):
    application_goods_list = ApplicationGoodsList(driver)
    application_goods_list.type_into_filter_description_search_box_and_filter(
        description
    )
...
def filter_by_description(driver, context, control_list):
    application_goods_list = ApplicationGoodsList(driver)
    application_goods_list.type_into_filter_control_rating_search_box_and_filter(
        control_list
    )
...
def total_goods_found(driver, total):
    ...
    assert total_goods == int(
        total
    ), "Incorrect number of goods matching search criteria were found"
