...
def test_add_site(driver, open_exporter_hub, url):
    ...
    driver.find_element_by_id("address.zip_code").send_keys("N23 6YL")
    driver.find_element_by_id("address.city").send_keys("London")
    driver.find_element_by_id("address.state").send_keys("Westminster")
...
def test_edit_site(driver, url):
    ...
    driver.find_element_by_id("address.state").clear()
    driver.find_element_by_id("address.state").send_keys("Westminster Edited")
