...
urlpatterns = [
    ...
    path("<uuid:pk>/confirm-raise-query/", views.ConfirmRaiseQuery.as_view(), name="confirm_raise_query"),
    path("<uuid:pk>/raise-clc-query/", views.RaiseCLCPVQuery.as_view(), name="raise_clc_query"),
