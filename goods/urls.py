...
urlpatterns = [
    ...
    path("<uuid:pk>/edit-firearm-details/type/", views.EditGrading.as_view(), name="firearm_type"),
    path("<uuid:pk>/edit-firearm-details/ammunition/", views.EditGrading.as_view(), name="ammunition"),
    path("<uuid:pk>/edit-firearm-details/firearms-act/", views.EditGrading.as_view(), name="firearms_act"),
    path(
