...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/documents/<uuid:file_pk>/", views.Document.as_view(), name="document"
    ),
    # ex: /goods/<uuid:pk>/documents/<uuid:file_pk>/delete/ - Delete a document
    path(
        "<uuid:pk>/documents/<uuid:file_pk>/delete/",
    ...
    path(
        "<uuid:pk>/raise-clc-query/",
        views.RaiseCLCQuery.as_view(),
        name="raise_clc_query",
    ),
    ...
    path(
        "<uuid:pk>/ecju-queries/<uuid:query_pk>/",
