...
def draft_summary(draft):
    ...
    return Summary(
        values={
            ...
            strings.applications.ApplicationSummaryPage.TYPE: draft.get_application_sub_type(),
...
def application_summary(application):
    ...
    return Summary(
        values={
            ...
            strings.applications.ApplicationSummaryPage.TYPE: application.get_application_sub_type(),
