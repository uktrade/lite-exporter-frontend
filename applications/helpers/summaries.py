...
def draft_summary(draft):
    ...
    return Summary(
        values={
            ...
            strings.applications.ApplicationSummaryPage.TYPE: draft["case_type"]["sub_type"],
...
def application_summary(application):
    ...
    return Summary(
        values={
            ...
            strings.applications.ApplicationSummaryPage.TYPE: application["case_type"]["sub_type"],
