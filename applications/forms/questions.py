...
def questions_forms():
    return FormGroup([
        Form(title="Does your application need to be expedited?", questions=[
            RadioButtons(
                name="expedited",
                options=[
                    Option(key=True, value="Yes", components=[
                        TextArea(name="expedited_description", description="Description 1")
                    ]),
                    Option(key=False, value="No"),
                ]
             )
        ]),
        Form(title="Is any foreign technology or information is involved in the proposed release", questions=[
            RadioButtons(
        ...
        Form(title="Is local assembly/local manufacture of the product is required", questions=[
            RadioButtons(
        ...
        Form(title="Are the goods rated under the Missile Technology Control Regime (MTCR)", questions=[
            RadioButtons(
                name="mtcr_type",
                options=[
                    # Option(key=True, value="Yes", components=[
        ...
        Form(title="What is the total value of the application prospect", questions=[
            TextArea(
                name="question_7",
