...
def which_location_form(draft_id):
    return Form(
        title=get_string("goods.location_questions.location.title"),
        ...
        questions=[
            RadioButtons(
                ...
                [
                    Option(
                        "organisation",
                        get_string("goods.location_questions.location.my_sites"),
                    ),
                    Option(
                        "external",
                        get_string(
                            "goods.location_questions.location.external_locations"
                        ),
                    ),
                ],
            )
        ...
        back_link=BackLink(
            "Back to Overview", reverse("applications:edit", kwargs={"pk": draft_id})
        ),
    )
