...
urlpatterns = [
    ...
    path("<uuid:pk>/end-user/edit/", end_users.EditEndUser.as_view(), name="edit_end_user"),
    ...
    path("<uuid:pk>/consignee/edit/", consignees.EditConsignee.as_view(), name="edit_consignee"),
