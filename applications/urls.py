...
urlpatterns = [
    ...
    path("<uuid:pk>/end-user/edit/", end_users.SetEndUser.as_view(), name="edit_end_user"),
    ...
    path("<uuid:pk>/consignee/edit/", consignees.SetConsignee.as_view(), name="edit_consignee"),
