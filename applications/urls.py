...
urlpatterns = [
    ...
    path(
        "<uuid:pk>/edit/type/", common.ApplicationEditType.as_view(), name="edit_type"
    ),
    path(
    ...
    path(
        ...
        common.RespondToQuery.as_view(),
        name="respond_to_query",
    ),
    path(
        "<uuid:pk>/open-goods/",
        goods.DraftOpenGoodsTypeList.as_view(),
        name="open_goods",
    ),
    path(
        "<uuid:pk>/goods-types/add/",
        goodstypeviews.ApplicationAddGoodsType.as_view(),
        name="add_goods_type",
    ),
    path(
        "<uuid:pk>/goods-types/remove/<uuid:goods_type_pk>/",
        goodstypeviews.ApplicationRemoveGoodsType.as_view(),
    ...
    path(
        "<uuid:pk>/goods/add-preexisting/",
        goods.GoodsList.as_view(),
        name="preexisting_good",
    ),
    path(
    ...
    path(
        "<uuid:pk>/location/existing-sites/",
        locations.ExistingSites.as_view(),
        name="existing_sites",
    ),
    path(
        "<uuid:pk>/location/external-locations/",
        locations.ExternalLocations.as_view(),
        name="external_locations",
    ),
    path(
        "<uuid:pk>/location/external-locations/add/",
        locations.AddExternalLocation.as_view(),
        name="add_external_location",
    ),
    path(
        "<uuid:pk>/location/external-locations/<uuid:ext_loc_pk>",
        locations.RemoveExternalLocation.as_view(),
        name="remove_external_location",
    ),
    path(
        "<uuid:pk>/location/external-locations/preexisting/",
        locations.AddExistingExternalLocation.as_view(),
        name="add_preexisting_external_location",
    ),
    path(
        "<uuid:pk>/location/countries/", locations.Countries.as_view(), name="countries"
    ),
    path("<uuid:pk>/end-user/", end_users.EndUser.as_view(), name="end_user"),
    path(
        "<uuid:pk>/end-user/remove",
        end_users.RemoveEndUser.as_view(),
        name="remove_end_user",
    ),
    path(
        "<uuid:pk>/end-user/document/attach",
        documents.AttachDocuments.as_view(),
        name="end_user_attach_document",
    ),
    path(
        "<uuid:pk>/end-user/document/download",
        documents.DownloadDocument.as_view(),
        name="end_user_download_document",
    ),
    path(
        "<uuid:pk>/end-user/document/delete",
    ...
    path(
        "<uuid:pk>/consignee/remove",
        third_parties.RemoveConsignee.as_view(),
        name="remove_consignee",
    ),
    path(
        "<uuid:pk>/consignee/document/attach",
        documents.AttachDocuments.as_view(),
    ...
    path(
        "<uuid:pk>/consignee/document/delete",
        documents.DeleteDocument.as_view(),
        name="consignee_delete_document",
    ),
    path(
        "<uuid:pk>/ultimate-end-users/",
        end_users.UltimateEndUsers.as_view(),
        name="ultimate_end_users",
    ),
    path(
        "<uuid:pk>/ultimate-end-user/<uuid:ueu_pk>/document/attach",
        documents.AttachDocuments.as_view(),
        name="ultimate_end_user_attach_document",
    ),
    path(
        "<uuid:pk>/ultimate-end-user/<uuid:ueu_pk>/document/download",
        documents.DownloadDocument.as_view(),
        name="ultimate_end_user_download_document",
    ),
    path(
        "<uuid:pk>/ultimate-end-user/<uuid:ueu_pk>/document/delete",
        documents.DeleteDocument.as_view(),
        name="ultimate_end_user_delete_document",
    ),
    path(
        "<uuid:pk>/ultimate-end-users/add",
        end_users.AddUltimateEndUser.as_view(),
        name="add_ultimate_end_user",
    ),
    path(
        "<uuid:pk>/ultimate-end-users/<uuid:ueu_pk>/remove",
        end_users.RemoveUltimateEndUser.as_view(),
        name="remove_ultimate_end_user",
    ),
    path(
        "<uuid:pk>/third-parties/",
        third_parties.ThirdParties.as_view(),
        name="third_parties",
    ),
    path(
        "<uuid:pk>/third-parties/add",
        third_parties.AddThirdParty.as_view(),
        name="add_third_party",
    ),
    path(
        "<uuid:pk>/third-parties/<uuid:tp_pk>/document/attach",
        documents.AttachDocuments.as_view(),
        name="third_party_attach_document",
    ),
    path(
        "<uuid:pk>/third-parties/<uuid:tp_pk>/document/download",
        documents.DownloadDocument.as_view(),
        name="third_party_download_document",
    ),
    path(
        "<uuid:pk>/third-parties/<uuid:tp_pk>/document/delete",
        documents.DeleteDocument.as_view(),
        name="third_party_delete_document",
    ),
    path(
        "<uuid:pk>/third-parties/<uuid:ueu_pk>/remove",
    ...
    path(
        "<uuid:pk>/additional-document/attach",
        documents.AttachDocuments.as_view(),
        name="attach_additional_document",
    ),
    path(
        "<uuid:pk>/additional-document/<uuid:doc_pk>/download",
        documents.DownloadDocument.as_view(),
        name="download_additional_document",
    ),
    path(
        "<uuid:pk>/additional-document/<uuid:doc_pk>/delete",
        documents.DeleteDocument.as_view(),
        name="delete_additional_document",
    ),
    path(
        "<uuid:pk>/<str:type>/",
        common.ApplicationDetail.as_view(),
