...
urlpatterns = [
    ...
    path("export-licence/", views.ExportLicenceQuestions.as_view(), name="export_licence_questions"),
    path(
        "trade-control-licence/", views.TradeControlLicenceQuestions.as_view(), name="trade_control_licence_questions"
    ),
