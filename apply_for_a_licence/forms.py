from libraries.forms.components import Form, ArrayQuestion, InputType, \
    DetailComponent, Question, Option, \
...
initial_questions = Section('', '', [
    ...
    Form('Which export licence do you want to apply for?',
         'Select one of the options.', [
             ArrayQuestion(title='',
                           ...
                           name='licence_type',
                           data=[
                               Option(key='standard_licence',
                                      value='Standard Individual Export '
                                            'Licence (SIEL)',
                                      description='SIELs are specific to the '
                                                  'company and the recipient '
                                                  '(consignee). '
                                                  'They are for a set quantity'
                                                  ' and set value of goods. '
                                                  'You will need to provide '
                                                  'support documentation with '
                                                  'your application.'),
                               Option(key='open_licence',
             ...
             DetailComponent('Help with choosing a licence',
