...
def MOD_questions():
    return FormGroup(
        [
            Form(
                title="What are you mod applying for?",
                description="mod description",
                questions=[
                    RadioButtons(
                        name="application_type",
                        options=[
                            Option(key="permission", value="Permission to share information", description="",),
                            Option(key="exhibition_clearance", value="Exhibition clearance", description="",),
                            Option(key="gifting_clearance", value="Gifting clearance", description="",),
                        ],
                    ),
                ],
                default_button_name=strings.CONTINUE,
