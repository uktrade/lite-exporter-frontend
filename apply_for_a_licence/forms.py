...
def initial_questions():
    return FormGroup([
        Form(title=get_string('applications.initial_questions.export_title'),
             questions=[
        ...
        Form(title=get_string('applications.initial_questions.reference_title'),
             questions=[
                 TextInput(name='name'),
             ],
             default_button_name='Continue'),
        Form(title='Do you want to export temporarily or permanently',
             description='',
             questions=[
             ...
             default_button_name='Continue'),
        Form(title='Have you been told that you need an export licence by an official?',
